<template>
  <div class="main" ref="container" @scroll="handleScroll">
    <img src="../assets/images/main-top.png" alt="" />
      ...
      >
        ...
        <van-tab>
          ...
          <div class="tab-content">
            ...
            <router-link class="btn" to="/qzvideo">
            </router-link>
          </div>
        </van-tab>
      ...
      <div class="tuiding-mask" style="z-index: 999; width:85vw">
        ...
        >
          ...
          <div style="margin: 3.72vw; width:90%; display: flex; justify-content: space-between;">
            <button @click="cancelAgree" id="agreeCancel" >取消</button>
    ...
    <div class="rules-container">
      <div style="width: 86%; margin:auto;">
        1．“咪咕音乐视宣号标准版”面向<b>中国移动</b>用户（不含港澳台）订购，资费<b>30元/月</b>，通过<b>话费</b>收取，<b>订购立即生效，退订立即失效</b>，退订的次月起不再收费。
        <br>2．该业务可享专区页面使用模板或上传短视频制作店铺专属视频彩铃、彩印(网内2000条/月)、挂机短信(50条/月)等权益。<b>（注：专区页面可通过微信服务号“咪咕视宣号-订购服务-商户中心”进入。）</b>
        ...
        <br>3．<b>即日起截至2026年12月31日24:00</b>，通过此页面订购该业务的用户，在订购期内，<b>每月</b>可领取1张<b>50元</b>特来电充电抵扣券。进入“咪咕音乐App-我的-全部（页面中部四个方块图标）-权益中心”，根据提示进行领取，当月内领取有效。于领取成功后的<b> 2 小时</b>内发放至对应手机号的特来电账号，使用有效期为到账日起<b>30天</b>。可用于通过特来电App或微信小程序充电时抵扣电费或服务费。可通过“特来电App-我的-卡券”查看。
        <br>4．订购该业务时，为保障业务能正常生效，将为您<b>同步开通</b>视频彩铃功能（如已开通则不会重复开通），资费<b>0元/月</b>，开通立即生效，退订立即失效（部分省份退订视频彩铃功能为次月生效，具体以所属省份规定为准）；如不退订，资费将保持0元/月。
        <br>5．订购该业务后，进入<b>微信服务号“咪咕视宣号-订购服务-商户中心”，</b>用订购业务手机号码登录后使用业务权益。使用“挂机短信”和“彩印”权益时，需根据提示开通“企业彩印-主被叫彩印体验版”（如已开通则不会重复开通），资费<b>0元/月</b>；开通立即生效，退订立即失效（部分省份退订企业彩印-主被叫彩印体验版功能为次月生效，具体以所属省份规定为准）；如不退订，资费将保持0元/月。<b>(注:浙江地区用户暂不支持挂机短信、彩印服务。)</b>
        <br>6．使用该业务权益制作的店铺专属视频彩铃时长需在<b>7-48秒</b>内，<b>彩铃名称及内容不能有涉及宗教、违法、违规、色情、反动、敏感、不文明用语、危害公共安全、不清晰、有噪音、无声音或某段无声音，视频画面倒置</b>等情况，上传的彩铃名称及内容会于<b>30分钟</b>内完成审核，审核通过后方可设置生效。审核结果可通过<b>微信服务号“咪咕视宣号-订购服务-商户中心-宣发视频”</b>查看。
        <br>7．使用该业务权益设置“挂机短信”和“彩印”，<b>内容不能有涉及宗教、违法、违规、色情、反动、敏感、不文明用语</b>，提交的内容会于<b>30分钟</b>内完成审核，审核通过后方可设置生效。审核结果可通过<b>微信服务号“咪咕视宣号-订购服务-商户中心-挂机短信/彩印"</b>查看。
        <br>8．退订该业务时，不关联退订已开通的视频彩铃功能和企业彩印-主被叫彩印体验版；退订视频彩铃功能或企业彩印-主被叫彩印体验版时，不关联退订该业务。但<b>无论退订视频彩铃功能还是该业务，设置的视频彩铃将不能再播放</b>；退订企业彩印-主被叫彩印体验版，无法使用“挂机短信"及“彩印”业务权益。
        <br>9．如需退订，可通过<b>所属省份10086热线、当地中国移动营业厅、中国移动App</b>进行退订。
        <br>10．上述业务均无合约捆绑，不涉及违约责任。有效期3年（36个自然月），如双方在有效期届满前无异议，有效期自动续展，每次续展3年；有效期内变更/退订/销户/携转，无需承担相应的违约责任。
        <br>11．办理发起后，平台会通过短信进行验证码、办理结果通知、客服信息等相关的告知，在发起办理时，即视为您同意接收短信。
        <br>11．业务平台客服电话：<a href="tel:4006163810">400-616-3810</a>（人工服务时间9:00-21:00）。
      </div>
    </div>

    <img src="../assets/images/btm.png" alt="">
...
export default {
  ...
  data() {
    return {
      ...
      pageLoadReported: false, // 页面加载埋点是否已上报
      mgEncryptedNum: '',
      // 业务办理日志相关
      businessTrace: {
        processId: 1, // 操作序号计数器，从1开始，逐次+1
        Fee: 30, // 当前办理金额
        GoodsId: '698039047105951781', // 产品ID
        GoodsName: '咪咕音乐视宣号标准版', // 商品名称
        SpServCode: '', // 业务代码
        ContentId: '' // 内容ID
      },
      mgOrderid: '',
  ...
  methods: {
    ...
    mobileInput(e) {
      ...
      if (
        ...
        // Amber - 业务办理日志: 输入手机号
        this.mgEncryptedNum = this.encryptPhoneNumber(this.mobile);
        this.reportBusinessTraceLog({
          processType: "1",
        })
      }
    },
    ...
    async getToken() {
      ...
      try {
        ...
        if (response.result && response.result.resCode === "000000") {
          ...
          // Amber - 账号登录行为
          this.reportUserLogin('0') //0:成功
          return response.result.token;
        } else {
          console.error("Invalid response structure", response);
          this.mToast(response.result.resMsg);
          // Amber - 账号登录行为
          this.reportUserLogin('1') //1:失败
          return false;
        }
      } catch (err) {
        this.mToast(err.resMsg);
    ...
    async queryPreCheck(token) {
      ...
      try {
        ...
        if (response.success) {
          ...
          this.mToast(
            (response.result && response.result.resMsg) || 
    ...
    cancel(token) {
      ...
      // Amber - 业务办理日志: 退订-前往办理(拉起统一支付页面时触发) 
      this.reportBusinessTraceLog({
        globalOptType: "3",  //3：退订
        processType: "2",
      }, "#confirmTD")
    ...
    fetchData() {
      ...
      window.openMiGuInit(this.channelCode,'window.initBackFun','paramdialog1','','','common2','',this.publicFields.sdkTraceId);  //Amber - add sdkTraceId to payment sdk
    ...
    orderBackFun(result) {
      this.mgOrderid = crypto.randomUUID();
      // console.log(JSON.stringify(result));
      console.log(result.resCode);
      if ("" + result.resCode === "000000") {
        ...
        // Amber - 业务办理日志: 办理结束-成功
        this.reportBusinessTraceLog({
          processType: "8",
          resultCode: "0", //0：成功
          cpId: this.bizInfoMon.cpId,
          orderId: this.mgOrderid,  //workaround - 前端随机生成uuid作为orderid
        })

        this.$router.push("/success"); // 接口返回成功，跳转到 Success.vue
      }
      else {
        clearTimeout(this.timerVailCode);
        this.timeVailCode = 60;
        ...
        // Amber - 业务办理日志: 办理结束-失败
        this.reportBusinessTraceLog({
          processType: "8",
          resultCode: "1", //1：失败
          errorMessage: result.resMsg,
          orderId: this.mgOrderid,  //workaround - 前端随机生成uuid作为orderid
        })
      }
    ...
    async fetchMobileData() {
      try {
        ...
        const response = await this.$http.post("/migu/areaCode", reqData);
        if (response.success) {
          return response.result;
        } else {
          console.error("[fetchMobileData]  - Invalid res: ", JSON.stringify(response));
          // this.mToast(response.message);
          return false;
        }
      } catch (err) {
        // this.mToast(err.message);
        console.error("fetchMobileData Request failed:", err.message);
      }
    },
    /* Amber SDK */
    async initAmberSDK() {
      ...
      const waitForSDK = () => {
        return new Promise((resolve) => {
          if (window.AmberWebSdk && window.AmberWebSdk.getSdkTraceId) {
            resolve()
          } else {
      ...
      // 获取 sdkTraceId
      if (window.AmberWebSdk && window.AmberWebSdk.getSdkTraceId) {
        this.publicFields.sdkTraceId = window.AmberWebSdk.getSdkTraceId()
        console.log('sdkTraceId:', this.publicFields.sdkTraceId)
      } else {
        console.warn('Amber SDK 未加载，getSdkTraceId 方法不存在')
      }
    },
    setPublicFields() {
      // 获取 URL 参数中的入口来源
      ...
      this.publicFields = {
        // 1.会话唯一链路ID
        sdkTraceId: this.publicFields.sdkTraceId,
        // 2.会话首次入口页面 URL 的 base64 编码
        entrySource: this.getEntrySource(),      
        // 3.流量来源平台类型（根据实际情况设置）
        sourceType: urlParams.sourceType || this.getDefaultSourceType(),
        // 4.流量来源平台（根据实际情况设置）
        sourcePlat: urlParams.sourcePlat || this.getDefaultSourcePlat(),
        // 5.设备类型
        globalPlatform: 1, //1:小屏（移动设备）
        // 6.页面层级标识（从 URL 获取或使用默认值）
        pageSeq: parseInt(urlParams.pageSeq) || 1,
        // 7.渠道ID，推广渠道
        channelId: this.channelCode,
        // 8.optional 当前页面名称
        pageName: '咪咕音乐视宣号标准版',
        // 9.optional 商品所属商户 ID（渠道ID前4位）
        merchantsId: '0021',
        // 10.optional 商品所属商户名称（公司名称）
        merchants: '成都盛川科技有限责任公司',
        // 11.归属公司ID
        companyId: 'MG002',
        // 12.归属公司名称
        companyName: '咪咕音乐',
        // 13.手机号码归属省份（获取手机号后更新），用户手机号码已获取后必填
        phoneProvince: '',
        // 14.手机号码归属地市（获取手机号后更新），用户手机号码已获取后必填
        phoneCity: '',
        // 15.用户标识（需要加密）
        userId: '',
      }
    ...
    getDefaultSourcePlat() {
      return '2'  //2：抖音
    },
    encryptPhoneNumber(phone) {
      try {
        const key = CryptoJS.enc.Utf8.parse('migu_qingyuan123');        
    ...
    // 构建 EPOP 参数
    async buildEPOP(customFields = {}) {
      var reg = /^1[3|4|5|7|8|9][0-9]{9}$/;
      if (reg.test(this.mobile)) {  //如果用户手机号码已获取，更新公共字段中的手机号相关参数
        this.publicFields.userId = this.encryptPhoneNumber(this.mobile);
        var mobileData = await this.fetchMobileData();
        if (mobileData && mobileData.code) {
          this.publicFields.phoneCity = mobileData.code; //省份/地市编码
        }
        if (mobileData && mobileData.parentCode) {  //省份编码，仅地市有值
          this.publicFields.phoneProvince = mobileData.parentCode;
        }
      }
    ...
    // 上报埋点事件
    async trackEvent(eventId, customFields = {}, async = true, ut = 'xhr') {
      const epop = await this.buildEPOP(customFields)
      if(window._amberTrack) {
        window._amberTrack(eventId, epop, async, ut)
        console.log(`埋点上报: ${eventId}`, epop)
      }
    },
    // 上报埋点-页面加载事件
    async reportPageLoad() {
      if (this.pageLoadReported) return

      let resultCode = '0'  //0:成功，1:失败
      let loadTime = '0'
      try {
        const calcLoadTime = () => {
          ...
          if (navigationEntries && navigationEntries.length > 0) {
            ...
            // 页面完全加载时间
            return String(Math.round(navigationTiming.loadEventEnd))
          }
          // 降级方案
          if (performance.now) {
        ...
        const report = () => {
          loadTime = calcLoadTime()
          this.doPageLoadReport(resultCode, loadTime)
        }
        // 页面已完成加载
        if (document.readyState === 'complete') {
          ...
          window.addEventListener('load',() => {
              setTimeout(report, 0) // 确保 loadEventEnd 已更新
            },
            { once: true }
          )
        }
    ...
    // 页面加载事件
    doPageLoadReport(resultCode, loadTime) {
      if (this.pageLoadReported) return
      ...
      this.trackEvent('qingyuan_page_load', customFields)
    },
    // 页面关闭时上报页面停留和关闭事件
    handlePageLeave() {
      console.log('[handlePageLeave] 页面刷新或关闭')
      if (!window._amberTrack) return
      if (this.pageStayReported) return

      /*1. 上报页面停留事件*/
      const stayTime = Date.now() - this.pageEnterTime
      const stayCustomFields = {
      ...
      // 转换为 [{EK: "key", EV: "value"}, ...] 格式
      for (const [key, value] of Object.entries(stayAllFields)) {
        if (value !== undefined && value !== null && value !== '') {
          epopStay.push({
            EK: key,
            EV: value
      ...
      window._amberTrack('qingyuan_page_stay', epopStay, true, 'beacon')
      console.log(`埋点上报: qingyuan_page_stay`, JSON.stringify(epopStay))
      /*上报页面停留事件*/

      /*2. 上报页面关闭事件*/
      if (this.mgOrderid && this.mgOrderid !== '') {  //有订购场景的页面关闭才上报
        const closeCustomFields = this.buildBusinessCustomFields({
          processType: "9", //9: 页面关闭
          orderId: this.mgOrderid,
        })
        const epopClose = []
        ...
        // 转换为 [{EK: "key", EV: "value"}, ...] 格式
        for (const [key, value] of Object.entries(closeAllFields)) {
          if (value !== undefined && value !== null && value !== '') {
            epopClose.push({
              EK: key,
              EV: value
        ...
        window._amberTrack('qingyuan_traceLog', epopClose, true, 'beacon')
        console.log(`埋点上报: qingyuan_traceLog`, JSON.stringify(epopClose))
        //操作序号+1
        this.businessTrace.processId++;
      }
      /*上报页面关闭事件*/
    },
    // 上报埋点-账号登录行为
    reportUserLogin(resultCode) {
      const encryptedPhone = this.encryptPhoneNumber(this.mobile);
      const customFields = {
        account: encryptedPhone,
        accountType: "1",  //1:手机号码账号
        phoneNumber: encryptedPhone,
        resultCode: resultCode, //0:成功,1:失败
      }
      this.trackEvent('qingyuan_user_login', customFields)
    },
    buildBusinessCustomFields(businessInfo, clickElement = '') {
      // 构建 setGeneralProps（页面信息）
      const setGeneralProps = {
        globalTypes: '1', // 1-话费支付
        globalOptType: businessInfo.globalOptType || '1', // 1-订购
        globalApiId: 'SDK', // 接口ID，如果是通过SDK办理的，该字段传【SDK】
        // globalApiName: 'MiguSdk.migupay' // 最终办理需要调用的接口名称(传产品受理的接口名称)
        globalApiName: '办理SDK' // 最终办理需要调用的接口名称(传产品受理的接口名称)
      }
      
      // 构建 bussinessProcessing（业务办理详情）
      const bussinessProcessing = {
        processId: this.businessTrace.processId,
        processType: businessInfo.processType,
        apiId: 'SDK',  //如果是通过SDK办理的，该字段传【SDK】
        apiName: '办理SDK',  //如果是通过SDK办理的，该字段传【办理SDK】
        payMethod: '3',  //3：话费,在processType为5：确认办理必填，其他环节选填
        orderId: businessInfo.orderId || '', //订单号，在processType为5：确认办理必填，其他环节选填
        fee: this.businessTrace.Fee, // 业务办理金额，单位元；processType为5：确认办理之后必填
        channelId: this.channelCode, //下单渠道编码，processType为5：确认办理之后必填
        cpId: businessInfo.cpId || '999999',  //业务合作伙伴ID，processType为5：确认办理后必填，没有填写：999999
        goodsId: this.businessTrace.GoodsId, //咪咕的产品ID，processType为5：确认办理后必填
        goodsName: this.businessTrace.GoodsName, //商品名称，processType为5：确认办理后必填
        spServCode: '', //业务代码 ，业务代码就是话费计费时传的servCode那个字段值
        contentId: '',  //内容ID，商品ID和内容ID（即节目id）至少选择填写一个
        phoneNumber: this.mgEncryptedNum || '',  //业务订购号码，processType为1：输入手机号之后必填
        resultCode: businessInfo.resultCode || '',  //业务办理结果返回码，0：成功,1：失败,processType为8：办理结束必填
        errorMessage: businessInfo.errorMessage || '' //resultCode为1时必填
      }

      const customFields = {
        setGeneralProps: setGeneralProps,
        bussinessProcessing: bussinessProcessing,
        clickElement: clickElement, //被点击元素的标识，用户有元素点击行为时必填，样例 {"EK":"clickElement","EV":"#postbtn"}
      }

      return customFields
    },
    // 上报埋点- 业务办理日志
    reportBusinessTraceLog(businessInfo, clickElement = '') {
      const customFields = this.buildBusinessCustomFields(businessInfo, clickElement);
      this.trackEvent('qingyuan_traceLog', customFields)
      //操作序号+1
      this.businessTrace.processId++;
    },
    /* Amber SDK */
  ...
  async mounted() {
    // Amber - SDK 初始化后获取 sdkTraceId
    await this.initAmberSDK()
    ...
    // Amber - 记录页面进入时间（用于停留时长）
    this.pageEnterTime = Date.now()
    // Amber - 上报页面加载埋点
    await this.reportPageLoad()
    // Amber - 监听页面刷新/关闭事件，上报页面停留事件
